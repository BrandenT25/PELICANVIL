    ...
    newCard.innerHTML = /* html */ `
            <div class="dataset-card-top">
                ...
                <div class="dataset-meta-row">
                  ...
                  ${dataset["indexed_size_bytes"] !== null && dataset["indexed_size_bytes"] !== undefined
                    ? `<span class="dataset-meta-badge dataset-meta-size" title="Real size from the indexing worker"><i class="fa fa-database"></i>${formatBytes(dataset["indexed_size_bytes"])}</span>`
                    : `<span class="dataset-meta-badge dataset-meta-size-unavailable" title="This dataset hasn't been indexed yet"><i class="fa fa-question-circle"></i>Size unavailable</span>`}
                </div>
            </div>
